...
#The regression results show that the intercept is 976.16 and the coefficient for education (edu) is 250.64.
#This means that when education is zero, the predicted income is 976.16 units.
#For each additional year of education, income increases by about 250.64 units on average.
#Both coefficients are statistically significant (p < 0.001), indicating a strong positive relationship between education and income
...
summary(model)
250.64/33.06 #==7.581367

# Check p-value
sprintf("%.20f",2.17e-06) #== 0.00000217000000000000"
